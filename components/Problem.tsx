                ...
                <div className="relative w-full max-w-4xl h-[500px] md:h-[600px] flex items-center justify-center">
                    ...
                    {timelineData.map((item, index) => {
                        ...
                        >
                            ...
                            {isExpanded && (
                            <Card className={cn(
                                "absolute left-1/2 -translate-x-1/2 bg-slate-900/95 backdrop-blur-xl border border-slate-700 shadow-2xl shadow-black/50 overflow-hidden z-50",
                                isMobile ? "w-64 top-16" : "w-72 top-20"
                            )}>
